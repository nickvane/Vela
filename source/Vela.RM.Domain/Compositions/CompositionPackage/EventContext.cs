//-----------------------------------------------------------------------
// <copyright file="EventContext.cs" company="Vela">
...
namespace Vela.RM.Domain.Compositions.CompositionPackage
{
	...
	{
		private IList<Participation> _participations;
		...
		public IList<Participation> Participations
		{
			get { return _participations ?? (_participations = new List<Participation>()); }
		}
